...
setup.initial_scaling=[2 .0057 .01 .0001 0.012]'; %note that right now there is no scaling parameter for the dirichlet params
...
setup.dirichlet_prior_parameters=[1;1;1;1];
