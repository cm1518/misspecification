function [zmat, B, C_final, D_final, add_matrices,inv_shock_std]=modelJPT2_for_irf(param,setup,data)
...
%new variable - GDP growth
gdp_growth=37+20;

NY=37+20; 
cum_gdp_growth=38+20;
NY=38+20; 
...
gamma_b=param(20);     % price indexation (=0 is static indexation, =1 is dynamic)
...
rhoR=param(19); rhoz=param(2); rhog=param(21); rhomiu=param(22); rholambdap=param(23); rholambdaw=param(24); rhob=param(25); rhomp=param(26);
...
GAM0(gdp_growth,gdp_growth)=1;
GAM0(gdp_growth,gdp)=-1;
GAM0(gdp_growth,gdp_1)=1;
GAM0(gdp_growth,z)=-1;

%cum gdp growth

GAM0(cum_gdp_growth,cum_gdp_growth)=1;
GAM0(cum_gdp_growth,gdp_growth)=-1;
GAM1(cum_gdp_growth,cum_gdp_growth)=1;
