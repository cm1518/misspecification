...
setup.wrapper{1}='model_2'; %NK model with wages
setup.wrapper{2}='model_3'; %NK model without wages
setup.wrapper{3}='model_5'; %large NK model
setup.wrapper{4}='rbc_new2'; %large NK model
setup.wrapper{5}='model_7_new'; %large NK model
